<?php
  ...
  class ContactController extends Library\View {
    ...
    public function send() {
      ...
      if (!$error) {
        ...
        $this->setData('response', '<div class="alert alert-success" role="alert">Le message est envoyé!</div>');
      }
      $this->render('contact', 'std');
    }
  }
