  ...
  class SignupController extends Library\View {
    ...
    public function default() {
      ...
      if (!empty($params['post'])) {
        ...
        if (!$error) {
          $this->setData('response', '<div class="alert alert-success" role="alert"><i class="fa-solid fa-hands-clapping text-success"></i> Votre inscription est validée !<br/>Vous pouvez maintenant vous authentifier et commencer à poster des commentaires.</div>');
